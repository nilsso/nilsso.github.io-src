...
<table>
    ...
    <td>![D1](img/gate_of_guidance/room_D1.png)</td>
    <td></td>
    <td></td>
    <td></td>
    </tr>
    ...
    <td></td>
    <td></td>
    <td>![D2](img/gate_of_guidance/room_D2.png)</td>
    <td>![E2](img/gate_of_guidance/room_E2.png)</td>
    <td>![F2](img/gate_of_guidance/room_F2.png)</td>
    <td>![G2](img/gate_of_guidance/room_G2.png)</td>
    </tr>
    <tr>
    <th>3</th>
    <td>![A3](img/gate_of_guidance/room_A3.png)</td>
    <td>![B3](img/gate_of_guidance/room_B3.png)</td>
    <td>![C3](img/gate_of_guidance/room_C3.png)</td>
    <td>![D3](img/gate_of_guidance/room_D3.png)</td>
    <td></td>
    <td></td>
    <td></td>
    </tr>
    ...
    <th>4</th>
    <td></td>
    <td>![B4](img/gate_of_guidance/room_B4.png)</td>
    <td>![C4](img/gate_of_guidance/room_C4.png)</td>
    <td>![D4](img/gate_of_guidance/room_D4.png)</td>
    <td>![E4](img/gate_of_guidance/room_E4.png)</td>
    <td></td>
    <td></td>
    </tr>
    <tr>
    <th>5</th>
    <td></td>
    <td>![B5](img/gate_of_guidance/room_B5.png)</td>
    <td>![C5](img/gate_of_guidance/room_C5.png)</td>
    <td>![D5](img/gate_of_guidance/room_D5.png)</td>
    <td>![E5](img/gate_of_guidance/room_E5.png)</td>
    <td></td>
    <td></td>
    </tr>
    <tr>
    <th>6</th>
    <td>![A6](img/gate_of_guidance/room_A6.png)</td>
    <td>![B6](img/gate_of_guidance/room_B6.png)</td>
    <td></td>
    <td></td>
    <td></td>
    <td></td>
...
## C1: Pillars Gate
![C1](img/gate_of_guidance/room_C1.png)
-   Skeleton
...
## D1: Pillars Gate
![D1](img/gate_of_guidance/room_D1.png)
-   Treasure: ?

## D2: Heavenly Temple of the Cross
![D2](img/gate_of_guidance/room_D2.png)
-   Save
...
![E2](img/gate_of_guidance/room_E2.png)
-   Seal
-   Treasure: ??
-   Tablet
...
## F2: Room of Courage
![F2](img/gate_of_guidance/room_F2.png)
-   Skeleton
...
## A3: Door to Eden
![A3](img/gate_of_guidance/room_A3.png)
...
![B3](img/gate_of_guidance/room_B3.png)
-   Tablet
...
![D3](img/gate_of_guidance/room_D3.png)
-   Skeleton
...
![B4](img/gate_of_guidance/room_B4.png)
-   Treasure: Holy Grail
-   NPC: Conversation
...
![D5](img/gate_of_guidance/room_D5.png)
...
![E5](img/gate_of_guidance/room_E5.png)
-   Ankh: Amphisbaena

## A6: Monument of Time
![A6](img/gate_of_guidance/room_A6.png)
...
## B6: Monument of Time
![B6](img/gate_of_guidance/room_B6.png)
-   NPC: Shop
...
<table>
    ...
    <td>![C1](img/mausoleum_of_the_giants/room_C1.png)</td>
    <td>![D1](img/mausoleum_of_the_giants/room_D1.png)</td>
    </tr>

    <tr>
    <th>2</th>
    <td>![A2](img/mausoleum_of_the_giants/room_A2.png)</td>
    <td>![B2](img/mausoleum_of_the_giants/room_B2.png)</td>
    <td>![C2](img/mausoleum_of_the_giants/room_C2.png)</td>
    <td>![D2](img/mausoleum_of_the_giants/room_D2.png)</td>
    </tr>
    ...
    <td></td>
    <td></td>
    <td>![D3](img/mausoleum_of_the_giants/room_D3.png)</td>
    <td>![E3](img/mausoleum_of_the_giants/room_E3.png)</td>
    <td>![F3](img/mausoleum_of_the_giants/room_F3.png)</td>
    <td>![G3](img/mausoleum_of_the_giants/room_G3.png)</td>
    </tr>
    ...
    <td></td>
    <td></td>
    <td>![E4](img/mausoleum_of_the_giants/room_E4.png)</td>
    <td>![F4](img/mausoleum_of_the_giants/room_F4.png)</td>
    <td>![G4](img/mausoleum_of_the_giants/room_G4.png)</td>
    <td>![H4](img/mausoleum_of_the_giants/room_H4.png)</td>
    </tr>

    <tr>
    <th>5</th>
    <td></td>
    <td>![B5](img/mausoleum_of_the_giants/room_B5.png)</td>
    <td>![C5](img/mausoleum_of_the_giants/room_C5.png)</td>
    <td>![D5](img/mausoleum_of_the_giants/room_D5.png)</td>
    <td>![E5](img/mausoleum_of_the_giants/room_E5.png)</td>
    </tr>
    ...
    <td></td>
    <td></td>
    <td>![E6](img/mausoleum_of_the_giants/room_E6.png)</td>
    </tr>
</table>

## B1: Last Shrine
![B1](img/mausoleum_of_the_giants/room_B1.png)
-   Skeleton
...
## C1: Last Shrine
![C1](img/mausoleum_of_the_giants/room_C1.png)
-   Tablet
...
![D1](img/mausoleum_of_the_giants/room_D1.png)
-   NPC: Conversation
...
![A2](img/mausoleum_of_the_giants/room_A2.png)
...
![B2](img/mausoleum_of_the_giants/room_B2.png)
-   Tablet
...
![C2](img/mausoleum_of_the_giants/room_C2.png)
-   Treasure: Map
-   Feature: Cross of Light
-   Tablet
...
## D3: Zebu's Room
![D3](img/mausoleum_of_the_giants/room_D3.png)
-   Feature: The Sealed Wall
-   Tablet
...
![E3](img/mausoleum_of_the_giants/room_E3.png)
-   Save
...
![F3](img/mausoleum_of_the_giants/room_F3.png)
-   NPC: Vendor
...
## G3: Dolphin's Room
![G3](img/mausoleum_of_the_giants/room_G3.png)
-   Tablet
>   Migela is left-handed.

## E4: Shaft to the Heavens
![E4](img/mausoleum_of_the_giants/room_E4.png)
-   Tablet
>   Zebu would no budge,  
...
![F4](img/mausoleum_of_the_giants/room_F4.png)
...
![H4](img/mausoleum_of_the_giants/room_H4.png)
-   Tablet
...
![D5](img/mausoleum_of_the_giants/room_D5.png)
-   Ankh: Sakit

## E5: Shaft to the Heavens
![E5](img/mausoleum_of_the_giants/room_E5.png)
-   Tablet
...
<table>
    ...
    <tr>
    <th>5</th>
    <td>![A5](img/spring_in_the_sky/room_A5.png)</td>
    <td></td>
    <td>![C5](img/spring_in_the_sky/room_C5.png)</td>
    <td>![D5](img/spring_in_the_sky/room_D5.png)</td>
    <td></td>
    </td>

    <tr>
    <th>6</th>
    <td>![A6](img/spring_in_the_sky/room_A6.png)</td>
    <td>![B6](img/spring_in_the_sky/room_B6.png)</td>
    <td>![C6](img/spring_in_the_sky/room_C6.png)</td>
    <td></td>
    <td></td>
    </td>
    ...
    <th>7</th>
    <td></td>
    <td>![B7](img/spring_in_the_sky/room_B7.png)</td>
    <td></td>
    <td></td>
    <td></td>
    </td>
...
## A5: ??
![A5](img/spring_in_the_sky/room_A5.png)
...
## C5: Sacred Lake
![C5](img/spring_in_the_sky/room_C5.png)
-   Tablet
...
## D5: Waterfall Approach
![D5](img/spring_in_the_sky/room_D5.png)

## A6: ??
![A6](img/spring_in_the_sky/room_A6.png)
-   Tablet
>   Open the floodgate.  
...
![C6](img/spring_in_the_sky/room_C6.png)
-   Feature: Cross of Light
-   Tablet
...
## B7: Mirror waterfall
![B7](img/spring_in_the_sky/room_B7.png)
-   Tablet
>   Sail away.  
...
<table>
    ...
    <td>![C1](img/temple_of_the_sun/room_C1.png)</td>
    <td></td>
    <td></td>
    <td></td>
    <td></td>
    ...
    <tr>
    <th>2</th>
    <td>![A2](img/temple_of_the_sun/room_A2.png)</td>
    <td>![B2](img/temple_of_the_sun/room_B2.png)</td>
    <td>![C2](img/temple_of_the_sun/room_C2.png)</td>
...
<table>
    ...
    <td>![X3](img/endless_corridor/room_X3.png)</td>
    <td>![X2](img/endless_corridor/room_X2.png)</td>
    <td>![X1](img/endless_corridor/room_X1.png)</td>
    </tr>
</table>

## ??: ??
![X4](img/endless_corridor/room_X4.png)
-   NPC: Fairy Queen
...
## ??: ??
![X3](img/endless_corridor/room_X3.png)
-   Infinity key hole

## ??: ??
![X2](img/endless_corridor/room_X2.png)
-   Seal
-   NPC: Hidden store
-   Skeleton
